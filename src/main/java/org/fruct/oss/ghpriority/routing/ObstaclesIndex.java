...
import org.fruct.oss.ghpriority.quadtree.Func;
import org.fruct.oss.ghpriority.quadtree.Node;
import org.fruct.oss.ghpriority.quadtree.QuadTree;
import org.fruct.oss.ghpriority.utils.Utils;
...
import org.fruct.oss.ghpriority.utils.Function;
...
public class ObstaclesIndex {
    ...
    public void queryByEdge(final double aLat, final double aLon, final double bLat, final double bLon,
        ...
        double degreesRadius = Math.toDegrees((radius / RADIUS_EARTH_METERS)
        ...
        quadtree.navigate(quadtree.getRootNode(), new Func() {
            ...
            public void call(QuadTree quadTree, Node node) {
                org.fruct.oss.ghpriority.quadtree.Point quadtreePoint = node.getPoint();
